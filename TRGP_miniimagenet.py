...
if __name__ == "__main__":
    ...
    parser.add_argument('--savename', type=str, default='./log/MiniImagenet/TRGP',
                        help='save path')
    ...
    log = open(os.path.join(args.savename,  'log_{}.txt'.format(str_time_)), 'w')

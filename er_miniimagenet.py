...
def train(args, model, device, x, y, optimizer, criterion, task_id, epoch, sv_history):
    model.train()
...
def main(args, str_time):
    ...
    mini_dataset = miniimagenet.DatasetGen(args)
    taskcla, inputsize = mini_dataset.taskcla, mini_dataset.inputsize
    ...
    for k, ncla in taskcla:
        ...
        for epoch in range(1, args.n_epochs + 1):
            # Train
            clock0 = time.time()
            train(args, model, device, xtrain, ytrain, optimizer, criterion, k, epoch, sv_history)
            clock1 = time.time()
...
if __name__ == "__main__":
    # Training parameters
    parser = argparse.ArgumentParser(description='MiniImagenet with ER')
    parser.add_argument('--algo_name', type=str, default='ER',
                        help='True or False')
    ...
    parser.add_argument('--buffer_size', type=int, default=500,
                        help='number of buffer_size (default: 500)')
    # PAPO parameters
    ...
    parser.add_argument('--lr_min', type=float, default=1e-3, metavar='LRM',
                        help='minimum lr rate (default: 1e-3)')
    ...
    parser.add_argument('--savename', type=str, default='./log/MiniImagenet/ER',
                        help='save path')
